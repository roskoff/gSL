...
#                                                 defaults = []),
#                                body = [
##                                   Assign(targets=[Name(id='a', ctx=Store())], value=Subscript(value=Name(id='identificadores', ctx=Load()), slice=Index(value=Num(n=0)), ctx=Load())) ,
#                                    Assign(targets = [Name(id = 'input_values', ctx=Store())],
...
#                                                                                              iter = Name(id = 'args', ctx=Load()),
#                                                                                              ifs=[])])),
#                                    Print(dest=None, values=[Subscript(value=Name(id='args_list', ctx=Load()), slice=Index(value=Num(n=0)), ctx=Load())], nl=True),
